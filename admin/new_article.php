	...
	<nav class="navbar navbar-expend-sm navbar-dark bg-dark text-light shadow-sm">
		...
		<div class="container-fluid">
			...
			<ul class="navbar-nav ml-auto" id="user-auth">
				...
				<li class="nav-item">
					<a id="" class="nav-link" id="user-profile" data-bs-toggle="modal" data-bs-target="#user-profile-detail">
						<span class="caret">
		...
		<div class="row shadow-sm" id="form-row">
			...
			<div class="col-sm-6 mt-3 mb-3 p-3 shadow-sm bg-light">
				<form action="add_article.php" method="post" enctype="multipart/form-data">
					...
					<div class="form-group">
						<input type="submit" name="submit" id="submit" value="Add New Article" class="btn btn-success form-control">
					</div>
				</form>
			</div>
			...
			<div class="col-sm-6 ml-5 mt-3 mb-3 shadow-sm bg-light">
				...
				<?php
				$result = mysqli_query($conn, "SELECT * FROM about_cars ORDER BY about_cars.created_date DESC LIMIT 1");
				$row = mysqli_fetch_assoc($result);
				?>
				
				<div class="post col-sm-10 p-3 m-auto bg-light">
				<div class="card-body">
					<h5 class="catd-title"><?php echo $row['title'];?></h5>
					<div class="card-subtitle mb-2 text-mutted small">
						<?php echo $row['created_date']; ?>

						<a class="card-link p-3" href="#">[ Delete ]</a>
						<a class="card-link p-3" href="#">[ Edit ]</a>
					</div>
